"""
A script to evaluate feature activity counts in and around a set of genomic intervals.

Example:
python generate_activity_counts.py
"""
import os
import pandas as pd
import pybedtools
...
def main():
    ...
    for filename in dataset_list:
        ...
        for activity_state in ACTIVITY_STATES:
            ...
            dataset = pd.read_pickle("data/ensembl_activity_data/" + filename)
            ...
            # Generating counts:
            feature_id = filename[:-4] + "_" + activity_state
    ...
    total_df.to_pickle("data/activity_counts.pkl")
